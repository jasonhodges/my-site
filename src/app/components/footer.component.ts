...
@Component({
  ...
  template: `
    <footer
      class="absolute inset-x-0 bottom-0 flex w-full flex-row items-center justify-evenly border-t border-base-300 bg-base-200 px-10 py-4 align-middle text-base-content">
